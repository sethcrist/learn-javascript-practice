...
// 6. Write a function named divisibleBy that takes two numbers as arguments and returns whether
// the first number is evenly divisible by the second so that divisibleBy(10, 5) logs "10 is evenly divisible by 5".
    // const divisibleBy = (num1, num2) => {
    //     if (num1 % num2 === 0) {
    //         return `${num1} and ${num2} is evenly divisible`
    //     } else {
    //         return `${num1} and ${num2} is not evely divisible`
    //     }
    // }
...
// 7. Write a function named assignGrade that takes a number score as an argument and returns the letter grade for the score.
    ...
    //         return "you have a C"
    //     } else if (num >= 60) {
    //         return "your are getting very close to failing"
    //     } else {
...
// 8. Write a function named isLonger that takes two strings as arguments and returns the string that contains the most characters.
    ...
    //         return `${str1} has less characters than ${str2}`
    //     } else {
    //         return `${str1} has the same characters as ${str2}`
    //     }
    // }
...
// 10. Write a function named yelling that takes a string as an argument and return the string in all uppercase case letters.
    ...
    // }
    // console.log(yelling("hello, my name is seth"));
